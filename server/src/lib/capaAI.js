...
2. Demand specifics: which stage, which machine, which operator/shift, which material lot or PO, what measurement vs. what the drawing requires, when it started, whether the previous batch was fine.
