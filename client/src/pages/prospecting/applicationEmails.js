...
export const APP_COPY = {
  "Autoclaves & sterilizers": {
    ...
    subjectIntro: "SS316 immersion heaters for $[FNAME|your]$ autoclaves",
  ...
  "Fluid bed dryers & granulation": {
    ...
    subjectIntro: "Finned air heaters for $[FNAME|your]$ FBD inlet banks",
  ...
  "Tablet coating & drying": {
    ...
    subjectIntro: "Coating pan inlet heaters for $[FNAME|your team]$",
  ...
  "Stability chambers & incubators": {
    ...
    subjectIntro: "Duct heaters for $[FNAME|your]$ stability chambers",
  ...
  "Ovens & furnaces": {
    ...
    subjectIntro: "Oven and muffle elements to $[FNAME|your]$ drawings",
  ...
  "Dissolution & water baths": {
    ...
    subjectIntro: "Bath elements for $[FNAME|your]$ dissolution units",
  ...
  "Aircraft manufacturing": {
    ...
    subjectIntro: "Cure oven and tank line elements for $[FNAME|your team]$",
  ...
  "Aircraft & engine MRO": {
    ...
    subjectIntro: "Tank heaters for $[FNAME|your]$ strip and clean lines",
  ...
  "UAV & composites": {
    ...
    subjectIntro: "Pitot and de-icing elements for $[FNAME|your team]$",
  ...
  "Heating elements & distribution": {
    ...
    subjectIntro: "Element manufacturing to drawing for $[FNAME|your team]$",
  ...
  "Boilers & steam": {
    ...
    subjectIntro: "Immersion bundles for $[FNAME|your]$ steam vessels",
  ...
  "Furnaces & kilns": {
    ...
    subjectIntro: "Coil and muffle windings for $[FNAME|your]$ furnaces",
  ...
  "Geysers & water heaters": {
    ...
    subjectIntro: "Tank elements for $[FNAME|your]$ water heaters",
  ...
  "Catering & bakery ovens": {
    ...
    subjectIntro: "Deck and cavity elements for $[FNAME|your]$ ovens",
  ...
  "Electroplating & finishing": {
    ...
    subjectIntro: "Tank heaters for $[FNAME|your]$ plating lines",
  ...
  "Industrial & curing ovens": {
    ...
    subjectIntro: "Finned elements for $[FNAME|your]$ oven builds",
  ...
  "Plastics machinery": {
    ...
    subjectIntro: "Band and cartridge heaters for $[FNAME|your]$ barrels",
  ...
  "Incubators & lab ovens": {
    ...
    subjectIntro: "Low density elements for $[FNAME|your]$ incubators",
...
export const GENERIC_COPY = {
  ...
  subjectFollow: 'Following up on element supply for $[FNAME|your team]$',
  hook: "I'm getting in touch because $[FNAME|your company]$ builds equipment that runs on heating elements, and that is the only thing we make. We manufacture tubular elements to drawing in SS304, SS316 and Incoloy 800 — CNC bent, furnace annealed and tested before they leave the floor.",
  bullets: [
 ...
 * `which` is 'intro' | 'follow'. $[FNAME|your]$ is left in place for Zoho to merge.
 */
